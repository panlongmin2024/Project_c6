...
#define ACT_LOG_MODEL_ID ALF_MODEL_LL
...
int cmd_advx(int argc, char *argv[])
{
	...
	ACT_LOG_ID_INF(ALF_STR_cmd_advx__ADV_PARAM_SET, 0);
...
disable:
	ACT_LOG_ID_INF(ALF_STR_cmd_advx__ADV_ENABLE_U, 1, enable);
...
exit:
	ACT_LOG_ID_INF(ALF_STR_cmd_advx__DONE_ERR_DN, 1, err);
...
int cmd_scanx(int argc, char *argv[])
{
	...
	ACT_LOG_ID_INF(ALF_STR_cmd_scanx__SCAN_PARAM_SET, 0);
...
disable:
	ACT_LOG_ID_INF(ALF_STR_cmd_scanx__SCAN_ENABLE_U, 1, enable);
...
exit:
	ACT_LOG_ID_INF(ALF_STR_cmd_scanx__DONE_ERR_DN, 1, err);
