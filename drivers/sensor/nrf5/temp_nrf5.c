...
#define ACT_LOG_MODEL_ID ALF_MODEL_TEMP_NRF5
...
static int temp_nrf5_sample_fetch(struct device *dev, enum sensor_channel chan)
{
	...
	ACT_LOG_ID_DBG(ALF_STR_temp_nrf5_sample_fetch__, 0);
				...
				struct sensor_value *val)
{
	...
	ACT_LOG_ID_DBG(ALF_STR_temp_nrf5_channel_get__, 0);
...
static int temp_nrf5_init(struct device *dev)
{
	...
	ACT_LOG_ID_DBG(ALF_STR_temp_nrf5_init__, 0);
