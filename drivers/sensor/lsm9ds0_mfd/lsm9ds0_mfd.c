...
#define ACT_LOG_MODEL_ID ALF_MODEL_LSM9DS0_MFD
...
static inline int lsm9ds0_mfd_sample_fetch_accel(struct device *dev)
{
	...
	if (i2c_reg_read_byte(data->i2c_master, config->i2c_slave_addr,
		...
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_sample_fetch_accel__FAILED_TO_READ_ACCEL, 0);
		return -EIO;
	}
...
static inline int lsm9ds0_mfd_sample_fetch_magn(struct device *dev)
{
	...
	if (i2c_reg_read_byte(data->i2c_master, config->i2c_slave_addr,
		...
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_sample_fetch_magn__FAILED_TO_READ_MAGN_, 0);
		return -EIO;
	}
...
static inline int lsm9ds0_mfd_sample_fetch_temp(struct device *dev)
{
	...
	if (i2c_reg_read_byte(data->i2c_master, config->i2c_slave_addr,
		...
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_sample_fetch_temp__FAILED_TO_READ_TEMPE, 0);
		return -EIO;
	}
...
static int lsm9ds0_mfd_init_chip(struct device *dev)
{
	...
	if (lsm9ds0_mfd_reboot_memory(dev) < 0) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_TO_RESET_DEVI, 0);
		return -EIO;
	}

	if (i2c_reg_read_byte(data->i2c_master, config->i2c_slave_addr,
			      LSM9DS0_MFD_REG_WHO_AM_I_XM, &chip_id) < 0) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_READING_CHIP_, 0);
		return -EIO;
	}

	if (chip_id != LSM9DS0_MFD_VAL_WHO_AM_I_XM) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__INVALID_CHIP_ID_0XX, 1, chip_id);
		return -EIO;
	}

	ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__CHIP_ID_0XX, 1, chip_id);
	...
	if (i2c_reg_update_byte(data->i2c_master, config->i2c_slave_addr,
		...
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_TO_SET_AODR_A, 0);
		return -EIO;
	}

	if (lsm9ds0_mfd_accel_set_fs_raw(dev, LSM9DS0_MFD_ACCEL_DEFAULT_FS)) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_TO_SET_ACCELE, 0);
		return -EIO;
	}
	...
	if (i2c_reg_update_byte(data->i2c_master, config->i2c_slave_addr,
				...
				1 << LSM9DS0_MFD_SHIFT_CTRL_REG1_XM_BDU)
				< 0) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_TO_SET_BDUN, 0);
		return -EIO;
	}
#endif
	...
	if (i2c_reg_update_byte(data->i2c_master, config->i2c_slave_addr,
				...
				< 0) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_TO_POWER_ON_M, 0);
		return -EIO;
	}

	if (lsm9ds0_mfd_magn_set_odr_raw(dev, LSM9DS0_MFD_MAGN_DEFAULT_M_ODR)) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_TO_SET_MAGNET, 0);
		return -EIO;
	}
	...
	if (i2c_reg_update_byte(data->i2c_master, config->i2c_slave_addr,
				...
				< 0) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init_chip__FAILED_TO_POWER_ON_T, 0);
		return -EIO;
	}
#endif
...
int lsm9ds0_mfd_init(struct device *dev)
{
	...
	if (lsm9ds0_mfd_init_chip(dev) < 0) {
		ACT_LOG_ID_DBG(ALF_STR_lsm9ds0_mfd_init__FAILED_TO_INITIALIZE, 0);
		return -EIO;
	}
