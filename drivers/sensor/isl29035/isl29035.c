...
#define ACT_LOG_MODEL_ID ALF_MODEL_ISL29035
...
static int isl29035_init(struct device *dev)
{
	...
	if (drv_data->i2c == NULL) {
		ACT_LOG_ID_DBG(ALF_STR_isl29035_init__FAILED_TO_GET_I2C_DE, 0);
		return -EINVAL;
	}
	...
	if (i2c_reg_update_byte(drv_data->i2c, ISL29035_I2C_ADDRESS,
		...
		ACT_LOG_ID_DBG(ALF_STR_isl29035_init__FAILED_TO_CLEAR_BLOW, 0);
		return -EIO;
	}
	...
	if (i2c_reg_write_byte(drv_data->i2c, ISL29035_I2C_ADDRESS,
		...
		ACT_LOG_ID_DBG(ALF_STR_isl29035_init__FAILED_TO_CLEAR_COMM, 0);
		return -EIO;
	}
	...
	if (i2c_reg_update_byte(drv_data->i2c, ISL29035_I2C_ADDRESS,
		...
		ACT_LOG_ID_DBG(ALF_STR_isl29035_init__FAILED_TO_SET_OPMODE, 0);
		return -EIO;
	}
	...
	if (i2c_reg_update_byte(drv_data->i2c, ISL29035_I2C_ADDRESS,
		...
		ACT_LOG_ID_DBG(ALF_STR_isl29035_init__FAILED_TO_SET_LUX_RA, 0);
		return -EIO;
	}
	...
	if (i2c_reg_update_byte(drv_data->i2c, ISL29035_I2C_ADDRESS,
		...
		ACT_LOG_ID_DBG(ALF_STR_isl29035_init__FAILED_TO_SET_ADC_RE, 0);
		return -EIO;
	}

#ifdef CONFIG_ISL29035_TRIGGER
	if (isl29035_init_interrupt(dev) < 0) {
		ACT_LOG_ID_DBG(ALF_STR_isl29035_init__FAILED_TO_INITIALIZE, 0);
		return -EIO;
	}
#endif
