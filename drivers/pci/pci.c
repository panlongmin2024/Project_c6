...
#define ACT_LOG_MODEL_ID ALF_MODEL_PCI
...
static void pci_set_command_bits(struct pci_dev_info *dev_info, u32_t bits)
{
	...
	ACT_LOG_ID_INF(ALF_STR_pci_set_command_bits__PCI_SET_COMMAND_BITS, 1, pci_ctrl_addr.value);
#endif
...
{
	ACT_LOG_ID_INF(ALF_STR_pci_show__PCI_DEVICEN, 0);
