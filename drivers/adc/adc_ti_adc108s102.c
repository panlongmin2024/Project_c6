...
#define ACT_LOG_MODEL_ID ALF_MODEL_ADC_TI_ADC108S102
#include <string.h>
#include <init.h>
...
static inline int _ti_adc108s102_sampling(struct device *dev)
{
	...
	ACT_LOG_ID_DBG(ALF_STR__ti_adc108s102_sampling__SAMPLINGN, 0);
...
static inline void _ti_adc108s102_handle_result(struct device *dev)
{
	...
	ACT_LOG_ID_DBG(ALF_STR__ti_adc108s102_handle_result___TI_ADC108S102_HANDL, 0);
...
static inline s32_t _ti_adc108s102_prepare(struct device *dev)
{
	...
	for (i = 0; i < seq_table->num_entries; i++) {
		...
		ACT_LOG_ID_DBG(ALF_STR__ti_adc108s102_prepare__REQUESTING_CHANNEL_D, 1, entry->channel_id);
	...
	ACT_LOG_ID_DBG(ALF_STR__ti_adc108s102_prepare__ADC108S102_IS_PREPAR, 0);
...
static int ti_adc108s102_init(struct device *dev)
{
	...
	ACT_LOG_ID_DBG(ALF_STR_ti_adc108s102_init__ADC108S102_INITIALIZ, 0);
