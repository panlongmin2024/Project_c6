...
#define ACT_LOG_MODEL_ID ALF_MODEL_SDIO_PORT
...
{
    ACT_LOG_ID_INF(ALF_STR_sdio_host_detect_card__SDIO_HOST_DETECT_CAR, 0);
    return true;
}
...
void sdio_in_read_reg(u32 addr)
{
	...
	ACT_LOG_ID_INF(ALF_STR_sdio_in_read_reg__0X08X_0X02XN, 2,  addr, value);
}

void sdio_read_sdio_reg()
{
	ACT_LOG_ID_INF(ALF_STR_sdio_read_sdio_reg__INTREN__0X04XN, 1,  gpRegSD0->IntrEn);
	ACT_LOG_ID_INF(ALF_STR_sdio_read_sdio_reg__INTRSIGEN__0X04XN, 1,  gpRegSD0->IntrSigEn);
	ACT_LOG_ID_INF(ALF_STR_sdio_read_sdio_reg__INTRSTS__0X04XN, 1,  gpRegSD0->IntrSts);
	ACT_LOG_ID_INF(ALF_STR_sdio_read_sdio_reg__ERRSTS__0X04XN, 1,  gpRegSD0->ErrSts);
