...
#define ACT_LOG_MODEL_ID ALF_MODEL_WDT_SAM
...
static void wdt_sam_enable(struct device *dev)
{
	...
	ACT_LOG_ID_ERR(ALF_STR_wdt_sam_enable__FUNCTION_NOT_IMPLEME, 0);
}
...
static int wdt_sam_set_config(struct device *dev, struct wdt_config *config)
{
	...
	ACT_LOG_ID_ERR(ALF_STR_wdt_sam_set_config__FUNCTION_NOT_IMPLEME, 0);
...
static void wdt_sam_get_config(struct device *dev, struct wdt_config *config)
{
	...
	ACT_LOG_ID_ERR(ALF_STR_wdt_sam_get_config__FUNCTION_NOT_IMPLEME, 0);
}
...
static void wdt_sam_reload(struct device *dev)
{
	...
	ACT_LOG_ID_ERR(ALF_STR_wdt_sam_reload__FUNCTION_NOT_IMPLEME, 0);
}
