...
#define ATS_AT_CMD_BTEDR_MAC				    "WLT_BTEDR_MAC"
#define ATS_AT_CMD_BTBLE_MAC				    "WLT_BTBLE_MAC"
#define ATS_AT_CMD_FIRMWARE_VERSION        		"WLT_FIRMWARE_VER"
#define ATS_AT_CMD_GPIO                			"WLT_TEST_GPIO"
#define ATS_AT_CMD_HARMAN_KEY		            "WLT_HARMAN_KEY"
