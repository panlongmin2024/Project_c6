...
struct dsp_pwr_t {
	volatile uint32_t power_latency;
	volatile uint32_t cpu_disable_dsp_wait;/**/
	volatile uint32_t dsp_wait_threshold;
	volatile uint32_t dsp_stat_period;
	volatile uint32_t dsp_work_percent;
	volatile uint32_t dsp_wait_percent;
	volatile uint32_t dsp_percent_cnt;
	volatile uint32_t dsp_idle_count_enable;
	volatile uint32_t dsp_wait;
};
...
extern void dsp_wait_set_latency_prio(bool prio);

extern int dsp_wait_get_latency_prio(void);

extern void dsp_wait_disable_read_buf_condition_satisfy(void);

extern void dsp_wait_enable_read_buf_condition_satisfy(void);

extern void dsp_wait_disable_write_buf_condition_satisfy(void);

extern void dsp_wait_enable_write_buf_condition_satisfy(void);

extern int dsp_wait_get_write_buf_condition_satisfy(void);

extern int dsp_wait_get_work_percent(void);

extern int dsp_wait_get_wait_percent(void);

extern int dsp_wait_get_buf_condition_satisfy(void);

extern void dsp_wait_disable_cpu_allow(void);

extern void dsp_wait_enable_cpu_allow(void);

extern int dsp_wait_cpu_get_allow_flag(void);

extern int dsp_wait_get_cpu_to_dsp_param(void);

extern void dsp_wait_cpu_set_dsp_status_wait(int set);

extern int dsp_wait_set_work_threshold(int thd);

extern void dsp_wait_set_count_enable(int enable);

extern int dsp_acts_wait_set_stat_period(int period);

extern void dsp_wait_disable_bt_read_buf_condition_satisfy(void);

extern void dsp_wait_enable_bt_read_buf_condition_satisfy(void);

extern void dsp_wait_forbit_dsp_wait_lock(void);

extern void dsp_wait_forbit_dsp_wait_unlock(void);

#endif

extern void dsp_wake_from_wait(void);
