 ...
 *
 *  @param mac remote bluetooth mac address.
...
/** @brief bluetooth enter sniff mode
 *
 * @param conn bt_conn conn
 *
 * @return Zero if done successfully, other indicator failed.
 */
int bt_enter_sniff(void *conn);

/** @brief bluetooth exit sniff mode
 *
 * @param conn bt_conn conn
 *
 * @return Zero if done successfully, other indicator failed.
 */
int bt_exit_sniff(void *conn);
