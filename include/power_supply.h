...
#define POWER_SUPLAY_CONTORL_PIN_G1                 50
...
enum  power_supply_status{
	...
	POWER_SUPPLY_STATUS_EXT_CHARGING,
	POWER_SUPPLY_STATUS_FORCE_DISPLAY,
#endif	
};
...
#ifdef CONFIG_WLT_MODIFY_BATTERY_DISPLAY
	POWER_SUPPLY_PROP_REMAIN_CHARGE_TIME,
	POWER_SUPPLY_PROP_BAT_TEMP,
#endif
};
...
#ifdef CONFIG_WLT_MODIFY_BATTERY_DISPLAY
	BAT_CHG_EVENT_TEMP_CHANGE,   //!< 温度变化
#endif
} bat_charge_event_t;
