...
typedef enum {
	TASK_WDT_CHANNEL_SYSTEM_APP,
	TASK_WDT_CHANNEL_MAIN_APP,
	TASK_WDT_CHANNEL_MEDIA_SRV,
	TASK_WDT_CHANNEL_BT_SRV,
	TASK_WDT_CAHNNEL_MAX,
} task_wdt_channel_e;

/** Task watchdog callback. */
typedef void (*task_wdt_callback_t)(uint32_t channel_id, void *user_data);
...
/**
 * @brief Feed all valid watchdog channel.
 *
 * This function loops through all installed task watchdogs and updates the
 * internal kernel timer used as for the software watchdog with the next due
 * timeout.
