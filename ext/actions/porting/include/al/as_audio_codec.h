...
#include "lib_k1_ape_p.h"
#include "lib_k1_fla_p.h"
#include "lib_k1_wav_e.h"
#include "lib_k1_wav_p.h"
#include "lib_k1_w13_p.h"
...
typedef int (*audio_parser_ops_t)(void *hnd, audio_parser_ex_ops_cmd_t cmd, unsigned int args);
/**
 ...
 * @return type of audio_parser_ret_t
 */
int as_parser_ops_mp3(void *hnd, audio_parser_ex_ops_cmd_t cmd, unsigned int args);
