...
#define BT_AVDTP_ERR_AAC_NOT_SUPPORTED_OBJECT_TYPE           0xD7
#define BT_AVDTP_ERR_AAC_INVALID_CHANNEL_MODE                0xD8
#define BT_AVDTP_ERR_AAC_NOT_SUPPORTED_CHANNEL_MODE          0xD9
...
struct bt_avdtp_seid_lsep *find_free_lsep_by_role_codectype(uint8_t role, struct bt_a2dp_media_codec *codec);
...
void bt_avdtp_ep_append_capabilities(struct net_buf *resp_buf, uint8_t reqSeid, bool all_capabilities);
