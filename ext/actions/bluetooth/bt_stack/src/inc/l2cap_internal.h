...
#define BT_L2CAP_CONF_FLOW_SPEC_REJ     0x0005
...
#define BT_L2CAP_CONF_OPT_RETRANS_FLOW_CTRL    0x04
#define BT_L2CAP_CONF_OPT_FCS                  0x05
#define BT_L2CAP_CONF_OPT_EXT_FLOW             0x06
#define BT_L2CAP_CONF_OPT_EXT_WINDOW_SIZE      0x07
...
/* Lookup channel by PSM */
struct bt_l2cap_chan *bt_l2cap_br_lookup_rx_psm(struct bt_conn *conn,
						uint16_t psm);
...
int bt_l2cap_br_chan_echo_req(struct bt_l2cap_chan *chan, uint8_t* echo_data, uint16_t len);
