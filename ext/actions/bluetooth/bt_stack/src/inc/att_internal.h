...
#define BT_LE_DATA_EXTENSION_LEN_MTU	256//247		/* 251 - 4, le long packet max length(251) */
...
#define BT_GATT_OVER_BR_LEN_MTU	  517
#define BT_ATT_OVER_BR_MTU	MIN(MIN(CONFIG_BT_L2CAP_RX_MTU, CONFIG_BT_L2CAP_TX_MTU), BT_GATT_OVER_BR_LEN_MTU)
