...
K_MEM_SLAB_DEFINE(chan_slab, sizeof(struct bt_att_chan),
		   (CONFIG_BT_MAX_CONN - CONFIG_BT_MAX_BR_CONN) * ATT_CHAN_MAX + (CONFIG_BT_MAX_BR_CONN * SUPPORT_GATT_OVER_BR),
 ...
 */
static struct bt_att *find_att(struct bt_conn *conn)
{
