...
#define BT_LE_AD_LE_EDR_SAME_DEVICE_CTRL  0x08 /* Simultaneous LE and BR/EDR to Same Device Capable (Controller) */
#define BT_LE_AD_LE_EDR_SAME_DEVICE_HOST  0x10 /* (Obsolete) Simultaneous LE and BR/EDR to Same Device Capable (Host)*/
