...
/*
 * almost same as bt_conn_disconnect(), the only different is
 * using handle instead of conn as parameter.
 */
...
struct bt_conn_cb {
	 ...
	 */
	bool (*connect_req)(bt_addr_t *peer,uint8_t *cod);
...
/** @brief Register br authentication callbacks.
 *
...
/** @brief Lookup conn Connection object
 *
 *  @param connection acl handle.
 *
