...
/**
 * @brief Make target App suspend
 *
 * This routine calls if the target app is actived , we suspend this target app
 *
 *
 * @param app_name name of target app.
 *
...
/**
 * @brief Make target App resume
 *
 * This routine calls if the target app is suspanded, we resume this target app
 *
 *
 * @param app_name name of target app.
 *
