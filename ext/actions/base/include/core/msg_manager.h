...
typedef enum
{
	...
	MSG_CHARGER_MODE_INIT,
	MSG_BATTERY_DISPLAY,
	MSG_FACTORY_RESET,
	MSG_MEDIA_EFFECT_BYPASS,
	MSG_SOFT_VERSION,
	MSG_SWITCH_SPI,
	MSG_ENTER_ATS,
	MSG_DSP_EFFECT_SWITCH,
	MSG_CLEAR_PAIRIED_LIST,
	MSG_EXTERN_CHARGE_MODE,
	MSG_EXIT_CHARGE_MODE,
	MSG_ENTERN_TWS_MODE,
	MSG_MCU_FW_UPDATE,
	MSG_ENTER_BQB,
	MSG_POWER_KEY,
