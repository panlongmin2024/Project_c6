...
void system_set_power_run_mode(int run_mode);
...
#ifdef CONFIG_BUILD_PROJECT_HM_DEMAND_CODE
	// user reboot reason start from 0x80.
	REBOOT_REASON_USER_GOTO_DEMO_FROM_NORMAL = 0x80,
	REBOOT_REASON_USER_GOTO_NORMAL_FROM_DEMO = 0x81,
	REBOOT_REASON_USER_ENTER_CHARGE = 0x82,
	REBOOT_REASON_REBOOT_AND_POWERON = 0x83,
#endif
};
